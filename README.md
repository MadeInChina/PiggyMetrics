...
# Piggy Metrics with spring-boot-2.0.4-SNAPSHOT
...
#### Production mode
In this mode, all 2.0.4-SNAPSHOT images will be pulled from Docker Hub.
...
#### Notes
All Spring Boot applications require already running [Config Server](https://github.com/sqshq/PiggyMetrics#config) for startup. But we can start all containers simultaneously because of `depends_on` docker-compose option.
